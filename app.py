...
def append_result():
    ...
    if request.method == "POST":
        ...
        conn.commit()
        conn.close()
        return render_template('append.html', form=form, msg_append_result=msg)
...
def append_student_to_event():
    ...
    if request.method == "POST":
        ...
        conn.commit()
        conn.close()
        return render_template('append.html', form=form, msg_student_to_event=msg)
    return render_template('append.html', form=form)
...
def insert_new_event():
    ...
    if request.method == "POST":
        ...
        conn.commit()
        conn.close()
        return render_template('append.html', form=form, msg_new_event=msg)
    return render_template('append.html', form=form)
...
def select_all_from_professors():
    ...
    if request.method == "POST":
        ...
        return render_template('outputs.html', form=form, output_professors=output)
...
def select_all_from_assistants():
    ...
    if request.method == "POST":
        ...
        return render_template('outputs.html', form=form, output_assistants=output)
    return render_template('outputs.html', form=form)
...
def select_all_from_events():
    ...
    if request.method == "POST":
        ...
        return render_template('outputs.html', form=form, output_events=output)
    return render_template('outputs.html', form=form)
...
def select_all_from_students():
    ...
    if request.method == "POST":
        ...
        return render_template('outputs.html', form=form, output_students=output)
    return render_template('outputs.html', form=form)
...
def get_event_listend_by_student():
    ...
    if request.method == "POST":
        ...
        return render_template('search.html', form=form, search_events_of_student=search)
...
def get_events_by_person():
    ...
    if request.method == "POST":
        ...
        conn.commit()
        conn.close()
        return render_template('search.html', form=form, search_events_of_person=search)
    return render_template('search.html', form=form)
...
def get_person_by_number():
    ...
    if request.method == "POST":
        ...
        return render_template('search.html', form=form, search_by_number=search)
    return render_template('search.html', form=form)
...
def get_person_by_name():
    ...
    if request.method == "POST":
        ...
        return render_template('search.html', form=form, search_by_name=search)
    return render_template('search.html', form=form)
...
def insert_new_professor():
    ...
    if request.method == "POST":
        ...
        conn.commit()
        conn.close()
        return render_template('append_persons.html', form=form, msg_professor=msg)
...
def insert_new_assistant():
    ...
    if request.method == "POST":
        ...
        conn.commit()
        conn.close()
        return render_template('append_persons.html', form=form, msg_assistant=msg)
    return render_template('append_persons.html', form=form)
...
def insert_new_student():
    ...
    if request.method == "POST":
        ...
        conn.commit()
        conn.close()
        return render_template('append_persons.html', form=form, msg_student=msg)
    return render_template('append_persons.html', form=form)
...
def delete_professor():
    ...
    if request.method == "POST":
        ...
        conn.commit()
        conn.close()
        return render_template('delete_persons.html', form=form, msg_professor=msg)
...
def delete_assistant():
    ...
    if request.method == "POST":
        ...
        conn.commit()
        conn.close()
        return render_template('delete_persons.html', form=form, msg_assistant=msg)
    return render_template('delete_persons.html', form=form)
...
def delete_student():
    ...
    if request.method == "POST":
        ...
        conn.commit()
        conn.close()
        return render_template('delete_persons.html', form=form, msg_student=msg)
    return render_template('delete_persons.html', form=form)
