...
def main():
    ...
    with conn:
        ...
        #insert_new_professor(conn, 1234567, "M@ttes", "R@ger", "W2", "D", 116)
        #insert_new_assistant(conn, 4567, "asdf", "asdf", "ja", 1234)
        #delete_professor(conn, 1234)
        #delete_assistant(conn, 4567)
        #delete_student(conn, 123456)
